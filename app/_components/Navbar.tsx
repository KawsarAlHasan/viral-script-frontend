    ...
    <div className="relative">
      <div className="navbar fixed top-0 right-0 left-0 z-50 navbar-backdrop bg-[var(--navbar-bg)]/95 border-b border-[var(--navbar-border)] py-4 lg:px-[120px]">
        ...
        <div className="navbar-start  flex-1 lg:flex-none">
          ...
          {/* <button
            onClick={hinddleOnClick}
            className="flex items-center space-x-3 logo-container cursor-pointer lg:mr-4"
          >
            <div className="relative">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 flex items-center justify-center shadow-lg transform rotate-3 hover:rotate-0 transition-transform duration-300">
                <svg
            ...
            <div>
              <h2 className="text-2xl font-bold logo-gradient leading-tight">
                ViralScript<span className="text-[var(--firstColor)]">Library</span>
              </h2>
        ...
        {/* Mobile Dropdown (Moved to navbar-end) */}
        ...
        {/* large device */}
        <div className="navbar-center hidden lg:flex pr-4">
